...
<form:form class="form-horizontal" method="post" modelAttribute="userBean">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input type="text" path="name" placeholder="Nombre completo" style="text-align:center" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<form:input id="appendedInput" type="email" path="email" placeholder="Correo electrónico" style="text-align:center" />
